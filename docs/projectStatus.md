...
| `docs/superpowers/plans/2026-06-01-groupings-phase3a-backend-cutover.md` | Groupings Phase 3a implementation plan — matcher, /groupings routes, question-flow cutover, proposal lifecycle, migration 018; 10 tasks (not yet implemented) |
