...
Execute all tests in `docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md` (Tests 1–6). All pass criteria in that document must be satisfied before proceeding.
