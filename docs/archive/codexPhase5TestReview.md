...
Date: 2026-04-13
Reviewer: Codex
Target: `docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md`
...
`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:5` limits scope to ingest, query CLI, SQL mode, cross-source views, and migration. The plan never exercises the Streamlit app, even though Phase 3 explicitly treated it as a shipped surface in manual testing (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase3.md:178-205`).
...
Phase 4 regression explicitly required the field coverage audit to keep working (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase4.md:43-47`). Phase 5 regression narrows that to only `scripts/query_cli.py` and default DB strings (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:33-37`).
...
The migration script copies both source tables (`scripts/migrate_to_duckdb.py:16-25`), but the manual test seeds only OpenNeuro before migration (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:143-154`). The expected outcome also treats Allen as an empty-table skip case (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:167-169`).
...
Phase 4 covered invalid SQL handling (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase4.md:181-189`). Phase 5 keeps the SQL happy path (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:113-135`) but removes the error-path check, even though the backend and dialect changed.
...
`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:31` tells the tester to rely on `docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase4.md`, but the current tracked Phase 4 plan is `docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase4.md:1`.
...
- Fresh DuckDB ingest for both sources (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:43-69`)
- Query CLI keyword, modality, source, and combined filters (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:73-109`)
- SQL summary and cross-source aggregation checks (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:113-135`)
- Migration script happy path plus rerun idempotency (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:139-197`)
- Re-ingest idempotency on DuckDB (`docs/testsPlans/completedAndPassedTestPlans/manualTestPlan_phase5.md:201-225`)
