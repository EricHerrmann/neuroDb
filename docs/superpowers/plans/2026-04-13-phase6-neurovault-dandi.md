...
| Create | `docs/testsPlans/manualTestPlan_phase6.md` | Manual test plan for Phase 6 |
...
**Files:**
- Create: `docs/testsPlans/manualTestPlan_phase6.md`

- [ ] **Step 1: Write the manual test plan**

Write `docs/testsPlans/manualTestPlan_phase6.md`:
...
```bash
git add docs/testsPlans/manualTestPlan_phase6.md
