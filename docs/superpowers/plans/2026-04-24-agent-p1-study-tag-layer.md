...
| `docs/testsPlans/manualTestPlan_agent_p1.md` | Create | Manual test plan for phase gate |
...
**Files:**
- Create: `docs/testsPlans/manualTestPlan_agent_p1.md`
...
```bash
git add docs/testsPlans/manualTestPlan_agent_p1.md
