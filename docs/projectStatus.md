...
| UI | `src/neurodb/ui/`, `src/neurodb/api/`, `frontend/` | UI-3 in progress — parity migration; React has all 7 write operations planned | Manual test plan active: `docs/testsPlans/manualTestPlan_ui3_parity_migration.md` |
